...
contract DSCEngineTest is Test {
    ...
    function setUp() public {
        ...
        if (block.chainid == 31337) {
            ...
            // Overwrite WETH's bytecode with the mock's bytecode
    ...
    function testRevertsIfMintedDscBreaksHealthFactor() public {
        ...
        uint256 expectedHealthFactor = dscEngine.calculateHealthFactor(amountToMint, collateralValue);
    ...
    // How to adjust the invariant tests for this?
